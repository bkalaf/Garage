<%@ Page Language="VB" AutoEventWireup="false" CodeFile="H03CreateQuote.aspx.vb" Inherits="H03CreateQuote" %>
<%@ Register Assembly="System.Web.Extensions, Version=1.0.61025.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35"
    Namespace="System.Web.UI" TagPrefix="asp" %>
<%--<%@ Reference Control="~/H03Controls/HeaderControl.ascx" %>--%>
...
<head id="Head1" runat="server">
    ...
    <title>SIU - Home Owners Quote Sheet</title>
   ...
   <body background="(EmptyReference!)" leftmargin="0" marginheight="0" marginwidth="0" topmargin="0">
    <center>
       ...
       <asp:PlaceHolder  ID="HeaderPh" runat="server"></asp:PlaceHolder>
          ...
          <div>
          <table border="0" cellspacing="0" cellpadding="0" style="background-color: White ;width: 800px">
               <tr>
       ...
       <asp:PlaceHolder  ID="AgencyInfoPh" runat="server"></asp:PlaceHolder>
        <asp:PlaceHolder  ID="RiskPh" runat="server"></asp:PlaceHolder>
        <asp:PlaceHolder  ID="Homeph" runat="server"></asp:PlaceHolder>
        ...
        <asp:PlaceHolder  ID="Coverageph" runat="server"></asp:PlaceHolder>
         <asp:PlaceHolder  ID="Quoteph" runat="server"></asp:PlaceHolder>
        <fieldset>
