...
Namespace GarageQuoteSheetDLL.H03
	Public Class WindHailLossHistory
		Implements IEntity
		...
		Private strTypeofLosses As String
		...
		Public Property TypeofLosses As String
			Get
				Return Me.strTypeofLosses
			End Get
			Set(ByVal value As String)
				Me.strTypeofLosses = value
			End Set
		End Property

		Public Property WindHailLossHistoryId As Integer Implements IEntity.Id
			Get
				Return Me.intID
			End Get
			Set(ByVal value As Integer)
		...
		Shared Sub New()
			WindHailLossHistory.logger = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType)
		End Sub
