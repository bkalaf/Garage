...
Namespace GarageQuoteSheetDLL
	Public Class InsuredOperation
		...
		Private _strOperationDetails As String
		...
		Public Property InsuredOperationId As Integer Implements IEntity.Id
			Get
				Return Me._intID
			End Get
			Set(ByVal value As Integer)
		...
		Public Property OperationDetails As String
			Get
				Return Me._strOperationDetails
			End Get
			Set(ByVal value As String)
				Me._strOperationDetails = value
			End Set
		End Property

		Shared Sub New()
			InsuredOperation.logger = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType)
		End Sub
