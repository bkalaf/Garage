Imports GarageQuoteSheetDLL.SIUService
...
Namespace GarageQuoteSheetDLL.My
	...
	Friend Module MyProject
		...
		Friend NotInheritable Class MyWebServices
			Public m_Service As Service

			Public Property Service As Service
				<DebuggerNonUserCode>
				Get
					Me.m_Service = MyProject.MyWebServices.Create__Instance__(Of Service)(Me.m_Service)
					Return Me.m_Service
				End Get
				<DebuggerNonUserCode>
				Set(ByVal value As Service)
					If (value <> Me.m_Service) Then
						If (value IsNot Nothing) Then
							Throw New ArgumentException("Property can only be set to Nothing")
						End If
						Me.Dispose__Instance__(Of Service)(Me.m_Service)
					End If
				End Set
			End Property
